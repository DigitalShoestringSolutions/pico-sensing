...
# Example for additional sensor
#flow_sensor_2 = FlowSensor(pin_num=26,            # A flow sensor connected to pin 26 (GP numbering)
#                           pulses_per_litre=50,   # that outputs 50 pulses per litre passed.
#                           data_tags={"machine":"MyMachineName2", "source":"MySourceName2"})  # Name the sensor and the water source
...
def cycle():
    ...
    #publish(flow_sensor_2.sample(), topic = "flow/" + flow_sensor_2.data_tags["machine"])  # Example for additional sensor
