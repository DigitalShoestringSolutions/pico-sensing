...
class BMP280:
    def __init__(self, i2cbus_num=0, sda_pin_num=None, scl_pin_num=None, addr=0x76, use_case=BMP280_CASE_HANDHELD_DYN):

#---
        # Default pin numbers depend on bus!
        ...
        self._bmp_i2c = machine.I2C(i2cbus_num, sda=machine.Pin(sda_pin_num), scl=machine.Pin(scl_pin_num))
#---
...
# ---
    ...
    def sample(self):
        return {
            ...
            "pressure" : self.pressure / 100, # units of hPa for now as that is what previous lib used
        }
